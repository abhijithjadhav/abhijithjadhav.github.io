            ...
            <div className='exp-list'>
              <ul>
                <li>
                  ...
                  <h5>AWS Developer - BA4 <span className='place'>Barclays</span></h5> <p>Pune</p>
            ...
            <div className='exp-list'>
              <ul>
                <li>
                  ...
                  <p>➡️ Performed the integration and unit testing of the application on the staging platform further the application was deployed on the production server.</p>
                </li>
              </ul>
            </div>
          </div>
